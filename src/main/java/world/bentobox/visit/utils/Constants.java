...
// ---------------------------------------------------------------------
     ...
     */
    public static final String TITLES = GUI + "titles.";

    /**
     * Reference string to BUTTON in translations.
     */
    public static final String BUTTONS = GUI + "buttons.";
...
// ---------------------------------------------------------------------
    ...
    /**
     * Reference string to noone-online parameter in translations.
     */
    public static final String PARAMETER_NOONE_ONLINE = "[noone-online]";

    /**
     * Reference string to payment parameter in translations.
     */
